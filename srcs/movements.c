...
/*   Updated: 2021/10/26 16:24:36 by dalves-p         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	key_press(int key, t_var *var)
{
	...
	if ((key == LEFT_KEY || key == A_KEY) &&
		...
		(var->map.map_mtx[var->sprite.position.y][var->sprite.position.x - 1] != 'E'))
	{
	...
	if ((key == DOWN_KEY || key == S_KEY) &&
		...
		(var->map.map_mtx[var->sprite.position.y + 1][var->sprite.position.x] != 'E'))
	{
		var->map.map_mtx[var->sprite.position.y][var->sprite.position.x] = '0';
